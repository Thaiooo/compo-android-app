...
public class ThemeDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (_fontTitle == null) {
			_fontTitle = Typeface.createFromAsset(getAssets(), FontEnum.DIALOG_TITLE.getName());
		}
		if (_fontContent == null) {
			_fontContent = Typeface.createFromAsset(getAssets(), FontEnum.DIALOG_CONTENT.getName());
		}
		if (_fontButton == null) {
