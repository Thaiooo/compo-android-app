...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "soccer_compo.db";
	...
	if (!dbExist) {
	    // By calling this method and empty database will be created into the default system path of your
	    // application so we are gonna be able to overwrite that database with our database.
