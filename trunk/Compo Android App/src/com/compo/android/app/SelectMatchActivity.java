...
public class SelectMatchActivity extends AbstractLSEFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_selectTheme = (Theme) intent
				.getSerializableExtra(PackFragment.MESSAGE_THEME);
		_selectPack = (Pack) intent
				.getSerializableExtra(PackFragment.MESSAGE_CURRENT_PACK);

		TextView activityTitle = (TextView) findViewById(R.id.activity_match_title);
		activityTitle.setTypeface(_fontTitle);
		activityTitle.setText(_selectTheme.getName() + " - "
				+ _selectPack.getName());
	...
	private class LoadMatchTask extends AsyncTask<Object, Void, List<Match>> {
		...
		protected List<Match> doInBackground(Object... params) {
			...
			User u = UserFactory.getInstance()
					.getUser(SelectMatchActivity.this);
			_mapQuizzToPlay = playDao.getAllPlay(u.getId());
			return matchList;
		}
		...
		protected void onPostExecute(final List<Match> aMatchList) {
			_selSelectMatchAdapter = new SelectMatchAdapter(
					SelectMatchActivity.this, aMatchList, _mapQuizzToPlay);
					...
					.setOnItemClickListener(new AdapterView.OnItemClickListener() {
						...
						public void onItemClick(AdapterView<?> parent, View v,
							...
							Intent intent = new Intent(
									SelectMatchActivity.this,
									MatchActivity.class);
							intent.putExtra(MatchActivity.REQ_MESSAGE_MATCH,
									selectMatch);
							intent.putExtra(MatchActivity.REQ_MESSAGE_PACK,
									_selectPack);
							startActivityForResult(intent,
									EXTRA_MESSAGE_REQUEST_CODE);
